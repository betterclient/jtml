...
public class HTMLInputElement extends HTMLElement<io.github.betterclient.jtml.internal.elements.HTMLInputElement> {
    public HTMLInputElement(HTMLDocument document, HTMLElement<?> parent, String text) {
        super(document, () -> new io.github.betterclient.jtml.internal.elements.HTMLInputElement(
                parent.getInternal(),
                new Element("input")
        ));
    ...
    public HTMLInputElement(HTMLDocument document, io.github.betterclient.jtml.internal.elements.HTMLInputElement element) {
