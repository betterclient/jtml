...
public class HTMLTextAreaElement extends HTMLElement<io.github.betterclient.htmlutil.internal.elements.HTMLTextAreaElement> {
    public HTMLTextAreaElement(HTMLDocument document, HTMLElement<?> parent, String text) {
        super(document, () -> new io.github.betterclient.htmlutil.internal.elements.HTMLTextAreaElement(
                parent.getInternal(),
    ...
    public HTMLTextAreaElement(HTMLDocument document, io.github.betterclient.htmlutil.internal.elements.HTMLTextAreaElement element) {
